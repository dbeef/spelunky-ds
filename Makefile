...
BUILD		:=	build
SOURCES		:=	source source/math source/tiles source/entities/_interfaces source/input  \
			...
			source/entities/singletons source/entities/singletons/states source/sound \
			source/entities/traps preprocessor/Debug.h
DATA		:=	data
INCLUDES	:=	include
FONTS   	:=	gfx/fonts
