...
#include "TitleMenuSign.h"
#include "../Globals.h"
#include "../../build/menu_signs_start_scores.h"
#include "../../build/menu_signs_tutorial_quit.h"
...
void TitleMenuSign::init() {
    ...
    switch (menuSignType) {
        ...
        case MenuSignType::QUIT:
            mainSpriteInfo_1 = used_oam_manager->initSprite(menu_signs_tutorial_quitPal, menu_signs_tutorial_quitPalLen,
                                                            nullptr, 16 * 16, 16, SpriteType::MENU_SIGNS_TUTORIAL_QUIT, true, false);
            mainSpriteInfo_2 = used_oam_manager->initSprite(menu_signs_tutorial_quitPal, menu_signs_tutorial_quitPalLen,
                                                            nullptr, 16 * 16, 16, SpriteType::MENU_SIGNS_TUTORIAL_QUIT, true, false);
            frameGfx1 = (u8 *) menu_signs_tutorial_quitTiles + 2 * 16 * 16 / 2;
            frameGfx2 = (u8 *) menu_signs_tutorial_quitTiles + 3 * 16 * 16 / 2;

            break;
        case MenuSignType::SCORES:
            mainSpriteInfo_1 = used_oam_manager->initSprite(menu_signs_start_scoresPal, menu_signs_start_scoresPalLen,
                                                            nullptr, 32 * 32, 32, SpriteType::MENU_SIGNS_START_SCORES, true, false);
            mainSpriteInfo_2 = used_oam_manager->initSprite(menu_signs_start_scoresPal, menu_signs_start_scoresPalLen,
                                                            nullptr, 32 * 32, 32, SpriteType::MENU_SIGNS_START_SCORES, true, false);
            frameGfx1 = (u8 *) menu_signs_start_scoresTiles + 2 * 32 * 32 / 2;
            frameGfx2 = (u8 *) menu_signs_start_scoresTiles + 3 * 32 * 32 / 2;
            break;
        case MenuSignType::START:
            ...
            mainSpriteInfo_2 = used_oam_manager->initSprite(menu_signs_start_scoresPal, menu_signs_start_scoresPalLen,
                                                            nullptr, 32 * 32, 32, SpriteType::MENU_SIGNS_START_SCORES, true, false);
            frameGfx1 = (u8 *) menu_signs_start_scoresTiles + 0 * 32 * 32 / 2;
            frameGfx2 = (u8 *) menu_signs_start_scoresTiles + 1 * 32 * 32 / 2;
            break;
        case MenuSignType::TUTORIAL:
            ...
            mainSpriteInfo_2 = used_oam_manager->initSprite(menu_signs_tutorial_quitPal, menu_signs_tutorial_quitPalLen,
                                                            nullptr, 16 * 16, 16, SpriteType::MENU_SIGNS_TUTORIAL_QUIT, true, false);
            frameGfx1 = (u8 *) menu_signs_tutorial_quitTiles + 0 * 16 * 16 / 2;
            frameGfx2 = (u8 *) menu_signs_tutorial_quitTiles + 1 * 16 * 16 / 2;
            break;
        default:
            break;
