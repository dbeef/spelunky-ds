...
#define RUBY_SMALL_SPRITE_SIZE RUBY_SMALL_SPRITE_WIDTH * RUBY_SMALL_SPRITE_HEIGHT

class RubySmall : public MovingObject, public Moniez {

public:

    void introduce_yourself() override { printf("RUBY SMALL\n"); };

    RubySmall();

    RubySmall(int x, int y, SpriteType sprite_type);
