...
void Copyrights::initSprite() {
    ...
    u8 *frameGfx2 = (u8 *) copyrightsTiles + 1 * 32 * 32 / 2;
    u8 *frameGfx3 = (u8 *) copyrightsTiles + 2 * 32 * 32 / 2;
    u8 *frameGfx4 = (u8 *) copyrightsTiles + 3 * 32 * 32 / 2;
    u8 *frameGfx5 = (u8 *) copyrightsTiles + 4 * 32 * 32 / 2;
