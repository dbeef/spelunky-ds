...
public:
    ...
    bool can_update_collidable() const override { return !hold_by_main_dude && !collided; }
    ...
    bool can_apply_friction() const override { return !collided; }

    bool can_apply_gravity() const override { return !collided; }
