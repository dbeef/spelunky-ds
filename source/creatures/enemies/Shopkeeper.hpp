...
public:
    ...
    bool can_update_collidable() const override { return !hold_by_main_dude && !_ready_to_dispose; }
    ...
    bool can_apply_friction() const override { return !hold_by_main_dude && _bottom_collision && (!triggered || killed || stunned); }
